...
############### from combined P log files


#Melt DATA (Tip+Node trees)
...
Pl1a<- ggplot(AllRunsrMelted, aes(x=Time_slice_1, y=net_speciation)) + 
...
Pl1b<- ggplot(AllRunsrMelted, aes(x=Time_slice_2, y=relative_extinction)) + 
...
Pl1c<- ggplot(AllRunsrMelted, aes(x=Time_slice_3, y=relative_fossilization)) + 
